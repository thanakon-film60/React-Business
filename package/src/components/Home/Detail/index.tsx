    ...
    <section className="relative bg-cover bg-center dark:bg-darkmode overflow-hidden py-10">
      <div className="container mx-auto max-w-[1100px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {cards.map((item, i) => (
            <div key={i} className="group relative w-full h-[250px] shadow-lg rounded-[16px] overflow-hidden flex items-end cursor-pointer">
              {/* รูป static */}
              <img
                src={item.staticImg}
                alt="static"
              ...
              />
              {/* title */}
              <p className="absolute bottom-0 left-0 m-2 text-white text-xl md:text-2xl lg:text-3xl font-extrabold drop-shadow-lg"
                style={{
                  textShadow: `
