      ...
      <div className="relative w-full h-[400px] md:h-[520px] lg:h-[600px]">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start max-w-6xl mx-auto py-16 gap-12 px-6 md:px-0">
          ...
          <div className="flex-1 space-y-6 text-green-900">
            <div>
              <h3 className="font-bold text-lg mb-1 text-green-700">วิสัยทัศน์</h3>
              <p className="text-base">ก้าวสู่ธุรกิจอาหารและวัตถุดิบ...</p>
            </div>
            <div>
              <h3 className="font-bold text-lg mb-1 text-green-700">พันธกิจ</h3>
          ...
          {/* ค่านิยมองค์กร */}
          <div className="flex-1 space-y-6 text-green-900">
            <h3 className="font-bold text-lg mb-1 text-green-700">ค่านิยมขององค์กร</h3>
            <ul className="list-disc ml-6 text-base">
              <li><b>T : Trust & Teamwork</b> ...</li>
              <li><b>V : Value Creation</b> ...</li>
              <li><b>G : Cooperation & Excellence</b> ...</li>
            </ul>
          </div>
        </div>
      </div>
